  ...
  return (
    ...
    >
      ...
      >
        {/* Front of Card */}
        <div 
          className="relative overflow-hidden rounded-xl border border-white/10 bg-[#0c1222] hover:border-white/20 hover:shadow-xl hover:shadow-black/20 transition-all duration-300"
        ...
        >
          <div className="h-full p-6 sm:p-8 lg:p-10 flex flex-col">
            {/* Back Button */}
            <button
            ...
            <div className="mt-auto">
              <button
                onClick={handleRegisterClick}
                className="px-8 py-3 rounded-lg font-bold text-sm uppercase tracking-wider transition-all duration-300 cursor-pointer text-white"
