      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-mono text-muted-foreground">
              <li><a href="mailto:zsavaseri@ethz.ch?subject=Mentorship Inquiry" className="hover:text-primary transition-colors">Mentor</a></li>
              <li><a href="mailto:zsavaseri@ethz.ch?subject=Sponsorship Inquiry" className="hover:text-primary transition-colors">Sponsor</a></li>
              <li><a href="mailto:zsavaseri@ethz.ch?subject=Volunteer Inquiry" className="hover:text-primary transition-colors">Volunteer</a></li>
            </ul>
          </div>
